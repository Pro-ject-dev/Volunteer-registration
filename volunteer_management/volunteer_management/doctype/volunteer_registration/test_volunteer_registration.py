...
class TestVolunteerRegistration(IntegrationTestCase):
	...
	def test_11_cancelled_registration_releases_capacity(self):
		settings = frappe.get_single("Volunteer Registration Settings")
		settings.female_staff_capacity = 1
		settings.save()
		...
		# Second registration should fail since cap=1
		doc2 = frappe.get_doc({
			"doctype": "Volunteer Registration",
			"participant_category": "Staff",
			"gender": "Female",
	...
	def test_15_female_student_capacity_limit(self):
		settings = frappe.get_single("Volunteer Registration Settings")
		settings.female_student_capacity = 2
		settings.save()
		...
		doc3 = frappe.get_doc({
			...
			"gender": "Female",
			"full_name": "Student 3",
			"enrollment_number": "CB.EN.U4CSE21053",
			"year_of_study": "1st Year",
			"course": "B.Tech",
			"branch": "Computer Science and Engineering",
			"school": "School of Engineering",
		...
		self.assertRaises(frappe.ValidationError, doc3.insert)
	...
	def test_17_concurrent_race_condition_simulation(self):
		# Set capacity to 1
		settings = frappe.get_single("Volunteer Registration Settings")
		settings.male_staff_capacity = 1
		settings.save()
		...
		# 2nd concurrent attempt should be blocked
		d2 = frappe.get_doc({
			"doctype": "Volunteer Registration",
			"participant_category": "Staff",
			"gender": "Male",
		...
		with self.assertRaises(frappe.ValidationError) as cm:
			d2.insert()
		self.assertIn("Male Staff volunteer capacity is full", str(cm.exception))
	...
	def test_19_availability_api_and_dashboard_stats(self):
		...
		self.assertEqual(fs["capacity"], 216)
		self.assertEqual(fs["registered"], 1)
		self.assertEqual(fs["remaining"], 215)
	...
	def test_21_male_student_and_staff_capacities(self):
		settings = frappe.get_single("Volunteer Registration Settings")
		settings.male_student_capacity = 1
		settings.female_staff_capacity = 1
		settings.male_staff_capacity = 1
		settings.save()
		...
		frappe.get_doc({
			...
			"enrollment_number": "CB.EN.U4CSE21301",
			"year_of_study": "1st Year",
			"course": "B.Tech",
			"branch": "Computer Science and Engineering",
			"school": "School of Engineering",
		...
		doc_m_over = frappe.get_doc({
			"doctype": "Volunteer Registration",
			"participant_category": "Student",
			"gender": "Male",
			"full_name": "Male Student 2",
			"enrollment_number": "CB.EN.U4CSE21302",
			"year_of_study": "1st Year",
			"course": "B.Tech",
			"branch": "Computer Science and Engineering",
			"school": "School of Engineering",
		...
		self.assertRaises(frappe.ValidationError, doc_m_over.insert)
		...
		frappe.get_doc({
			...
			"participant_category": "Staff",
			"gender": "Female",
			"full_name": "Female Staff 1",
			"department": "Department of Mathematics",
			"staff_school": "School of Physical Sciences",
			"contact_number": "9876543210",
		}).insert()

		doc_f_over = frappe.get_doc({
			"doctype": "Volunteer Registration",
			"participant_category": "Staff",
			"gender": "Female",
			"full_name": "Female Staff 2",
			"department": "Department of Mathematics",
			"staff_school": "School of Physical Sciences",
			"contact_number": "9876543211",
		})
		self.assertRaises(frappe.ValidationError, doc_f_over.insert)
		...
		frappe.get_doc({
			...
			"participant_category": "Staff",
			"gender": "Male",
			"full_name": "Male Staff 1",
			"department": "Department of Management",
			"staff_school": "School of Business",
			"contact_number": "9876543210",
		}).insert()

		doc_mst_over = frappe.get_doc({
			"doctype": "Volunteer Registration",
			"participant_category": "Staff",
			"gender": "Male",
			"full_name": "Male Staff 2",
			"department": "Department of Management",
			"staff_school": "School of Business",
			"contact_number": "9876543212",
		})
		self.assertRaises(frappe.ValidationError, doc_mst_over.insert)

	def test_22_overall_capacity_limit(self):
		settings = frappe.get_single("Volunteer Registration Settings")
		settings.female_student_capacity = 1
		settings.male_student_capacity = 1
		settings.female_staff_capacity = 0
		settings.male_staff_capacity = 0
		settings.save()
		self.assertEqual(settings.total_capacity, 2)
		...
		frappe.get_doc({
			...
			"gender": "Female",
			"full_name": "FS 1",
			"enrollment_number": "CB.EN.U4CSE21401",
			"year_of_study": "1st Year",
			"course": "B.Tech",
			"branch": "Computer Science and Engineering",
			"school": "School of Engineering",
		...
		# Register 1 male student
		frappe.get_doc({
			"doctype": "Volunteer Registration",
			"participant_category": "Student",
			"gender": "Male",
			"full_name": "MS 1",
			"enrollment_number": "CB.EN.U4CSE21402",
			"year_of_study": "1st Year",
			"course": "B.Tech",
			"branch": "Computer Science and Engineering",
			"school": "School of Engineering",
		...
		# Total 2 is reached. Even if female_student_capacity is raised to 2, total_capacity check limits if not saved or exceeded
		stats = VolunteerRegistrationSettings.get_live_stats()
		self.assertEqual(stats["total"]["registered"], 2)
		self.assertTrue(stats["total"]["is_full"])
